...
extension SecondCoordinator : SegueHandler {
    func coordinator(for segue: UIStoryboardSegue, sender: Any?) -> Coordinator? {
        ...
        case SecondCoordinatorSegues.second.rawValue: return ThirdCoordinator(viewController: segue.destination as! ThirdViewController, thirdScreenText: "From Parameter")
        default: return nil
        }
    }
}
